...
let s:yellow      = { "gui": "#ede49f", "cterm": "186" }
...
call s:h("LineNr",        { "fg": s:grey,       "bg": s:softblack })
call s:h("CursorLineNr",  { "fg": s:orange,     "bg": s:lightblack })
call s:h("SignColumn",    {                     "bg": s:lightblack })

" statusline
call s:h("StatusLine",    { "fg": s:black,      "bg": s:lightgrey })
call s:h("StatusLineNC",  { "fg": s:black,      "bg": s:lightblack })
